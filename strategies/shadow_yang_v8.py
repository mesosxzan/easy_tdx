...
PROFIT_LOCKIN_TRIGGER1 = 0.05  # V8: 3% → 5% 触发保本
PROFIT_LOCKIN_TRIGGER2 = 0.09  # V8: 6% → 9% 触发锁 3%
PROFIT_LOCKIN_FLOOR2 = 0.03    # V8: 2% → 3%
PROFIT_LOCKIN_TRIGGER3 = 0.15  # V8: 10% → 15% 触发锁 5%
PROFIT_LOCKIN_FLOOR3 = 0.05    # V8: 3% → 5%
PROFIT_LOCKIN_TRIGGER4 = 0.22  # V8: 15% → 22% 触发锁 10%
PROFIT_LOCKIN_FLOOR4 = 0.10    # V8: 7% → 10%
PROFIT_LOCKIN_TRIGGER5 = 0.30  # V8: 20% → 30% 触发锁 15%
PROFIT_LOCKIN_FLOOR5 = 0.15    # V8: 10% → 15%
...
PROFIT_LOCKIN_STRONG_TREND_MIN_TIER = 4  # V8: 3 → 4，强趋势从第 4 档(22%)才开始锁定
...
class ShadowYangStrategy(Strategy):
    """影线后收阳线策略 V8（盈利锁定阶梯放宽版）。

    V8 唯一改动：盈利锁定触发门槛整体上移 50%，锁定比例也相应提高。
    让更多中等盈利单有机会发展成大趋势单。
